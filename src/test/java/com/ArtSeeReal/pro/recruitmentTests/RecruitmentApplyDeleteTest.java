...
@SpringBootTest
@Transactional
public class RecruitmentApplyDeleteTest {
    ...
    @Autowired
    public RecruitmentApplyDeleteTest(RecruitmentService recruitmentService, UserService userService) {
    ...
    void 더미데이터_생성(){
        ...
        recruitmentService.applyRecruitmentCreate(userUid,recruitmentUid);
    }

    @Test
    void 공고_즐겨찾기_삭제_성공(){
        recruitmentService.applyRecruitmentDelete(userUid,recruitmentUid);
    }
}
